...
c***********************************************************************
      ...
      integer,parameter :: gas_nchain=3  !ni56/fe52/cr48
c
...
c-- domain decomposed grid variables used to calculate the state of the material (gas)
      ...
      real*8,allocatable :: gas_natom1fr(:,:) !(-6:gas_nelem,ncell)  !current natom fractions (>0:stable+unstable, -1:ni56, -2:co56, 0:container for unused elements)
...
c-- ndim=2 alloc small
      allocate(gas_natom1fr(-6:gas_nelem,gas_ncell))
      gas_natom1fr = 0d0
